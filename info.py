...
API_ID = int(environ['API_ID', '15432910'])
API_HASH = environ['API_HASH', 'bf3b5a92497cf5744e6310f309b5490a' ]
BOT_TOKEN = environ['BOT_TOKEN', '6180031203:AAFXisFZAG9YACmYb7rE1weJPRWK5JB_ssA']
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Fast_Download_Magaa™](https://t.me/Fast_Download_Magaa)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [MoviesAdda™](https://t.me/real_MoviesAdda2)</b> ↭  🔥")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001688874414')).split()]
MELCOW_NEW_USERS = is_enabled((environ.get('MELCOW_NEW_USERS', "True")), True)
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "True")), True)
PUBLIC_FILE_STORE = is_enabled((environ.get('PUBLIC_FILE_STORE', "True")), True)

#LazyRenamer Configs
FLOOD = int(environ.get("FLOOD", "10000"))
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'short.koklink.in') #Always use website url from api section 
